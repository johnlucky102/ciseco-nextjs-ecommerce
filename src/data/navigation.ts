...
export const NAVIGATION_DEMO_2: NavItemType[] = [
  ...
  },
  {
    ...
    type: "dropdown",
    children: [
      { id: ncNanoId(), href: "/collection", name: "Tất cả sản phẩm" },
      { id: ncNanoId(), href: "/collection", name: "Sofa & Ghế" },
      { id: ncNanoId(), href: "/collection", name: "Giường & Nệm" },
      { id: ncNanoId(), href: "/collection", name: "Bàn & Tủ" },
      { id: ncNanoId(), href: "/collection", name: "Kệ & Lưu trữ" },
      { id: ncNanoId(), href: "/collection", name: "Đèn & Phụ kiện" },
    ],
  },
  {
    id: ncNanoId(),
    ...
    type: "dropdown",
    children: [
      { id: ncNanoId(), href: "/search", name: "Tìm kiếm sản phẩm" },
      { id: ncNanoId(), href: "/cart", name: "Giỏ hàng" },
      { id: ncNanoId(), href: "/checkout", name: "Thanh toán" },
      { id: ncNanoId(), href: "/account", name: "Tài khoản của tôi" },
      { id: ncNanoId(), href: "/account-order", name: "Đơn hàng" },
      { id: ncNanoId(), href: "/account-savelists", name: "Yêu thích" },
      { id: ncNanoId(), href: "/about", name: "Về chúng tôi" },
