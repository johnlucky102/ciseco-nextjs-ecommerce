...
const FOUNDER_DEMO: People[] = [
  {
    ...
    job: "NhÃ  sÃ¡ng láº­p kiÃªm GiÃ¡m Ä‘á»‘c Ä‘iá»u hÃ nh",
    avatar:
  ...
  },
  {
    ...
    job: "NhÃ  sÃ¡ng láº­p kiÃªm GiÃ¡m Ä‘á»‘c sáº£n pháº©m",
    avatar:
  ...
  },
  {
    id: "3",
    name: `LÃª VÄƒn Äá»©c`,
    job: "NhÃ  sÃ¡ng láº­p kiÃªm Chá»§ tá»‹ch",
    avatar:
  ...
  {
    id: "2",
    name: `Pháº¡m Thanh Linh`,
    job: "NhÃ  sÃ¡ng láº­p kiÃªm GiÃ¡m Ä‘á»‘c chiáº¿n lÆ°á»£c",
    avatar:
...
const SectionFounder = () => {
  return (
    <div className="nc-SectionFounder relative">
      <Heading
        desc="Đội ngũ sáng lập Furzose với niềm đam mê nội thất và thiết kế không gian sống"
      >
        ⛱ Nhà Sáng Lập
      </Heading>
